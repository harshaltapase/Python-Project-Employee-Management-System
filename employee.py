...
class Employee:
    def __init__(self,root):
        ...
        # logo
        img_logo = Image.open('colleges_images/emplogo.png')
        ...
        # 1st
        img1 = Image.open('colleges_images/emp1.jpg')
        ...
        # 2nd
        img2 = Image.open('colleges_images/emp2.jpg')
        ...
        # 3rd
        img3 = Image.open('colleges_images/emp3.jpg')
        ...
        # mask Image
        img_mask = Image.open('colleges_images/img_mask.jpg')
        img_mask = img_mask.resize((220, 220))
        self.photomask = ImageTk.PhotoImage(img_mask)

        self.img_1 = Label(upper_frame, image=self.photomask)
        self.img_1.place(x=1000, y=0, width=220, height=220)
        ...
        search_by = Label(search_frame, text='Search By:', font=('arial', 11, 'bold'), bg='white')
        ...
        com_txt_search.grid(row=0, column=1, sticky=W, padx=5, pady=7)
        ...
        # logo Mask
        img_logo_mask = Image.open('colleges_images/emplogo.png')
        ...
        self.employee_table = ttk.Treeview(table_frame,column=('dept','name','desig','email','address','married','dob','doj','idproofcomb','idproof','gender','phone','country','salary',),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
    ...
    def add_data(self):
        if self.var_dep.get() == "" or self.var_email.get()=="":
            ...
            try:
                conn = mysql.connector.connect(host='localhost',username='root',password='Harshal@#2023',database='sys')
